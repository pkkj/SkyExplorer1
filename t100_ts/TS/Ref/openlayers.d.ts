...
declare module OpenLayers {
    ...
    export class Events {
         ...
         *     events.
         */
        register(type: string, obj: any, func: (e?: any) => void, priority?: boolean): void;
         ...
         * func - {Function} 
         */
        unregister(type: string, obj: any, func: (e?:any) => void): void;
    ...
    module Control {
        ...
        export class SelectFeature {
            ...
            unselect(feature: OpenLayers.Feature.Vector);
        }
    ...
    module Layer {
        ...
        export class Vector extends Layer {
            ...
            addFeatures(features: OpenLayers.Feature.Vector[], option?: Object);
            destroyFeatures(features?: OpenLayers.Feature.Vector[], option?: Object);
        }
