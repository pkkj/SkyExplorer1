...
declare module jquery.flot {
    ...
    interface legendOptions {
        ...
        container?: HTMLElement;         // null or jQuery object/DOM element/jQuery expression
...
interface JQueryStatic {
    plot(placeholder: string, data: jquery.flot.dataSeries[], options?: jquery.flot.plotOptions): jquery.flot.plot;
    plot(placeholder: string, data: any[], options?: jquery.flot.plotOptions): jquery.flot.plot;
}
