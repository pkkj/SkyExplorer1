...
namespace AST {
    ...
    public class AirportAvailabilityActorN {
        // TODO: Pay attention to T100FF data
        public static string QueryAirportYearAvailability( string airportCode, string dataSrc, string locale ) {
            NpgsqlConnection conn = null;
            try {
                ...
                AirportN airport = AirportDataN.Query( airportCode, locale );
                if ( airport == null ) return "";
